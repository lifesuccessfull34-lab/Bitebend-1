...
export const RegisterBody = zod.object({
  ...
  "restaurantCity": zod.string().describe('Actual city or town name; independent of district and must not be inferred or derived from it'),
  "restaurantState": zod.string().optional().describe('Indian state name (e.g. Maharashtra, Tamil Nadu)'),
  "restaurantDistrict": zod.string().optional().describe('Administrative district within the selected state (e.g. Pune, Coimbatore)'),
  "cuisineType": zod.enum(['north_indian', 'south_indian', 'chinese', 'continental', 'italian', 'mughlai', 'seafood', 'street_food', 'multi_cuisine', 'other'])
})
...
export const UpdateOwnerRestaurantBody = zod.object({
  ...
  "description": zod.string().nullish(),
  "cuisineType": zod.enum(['north_indian', 'south_indian', 'chinese', 'continental', 'italian', 'mughlai', 'seafood', 'street_food', 'multi_cuisine', 'other']).optional(),
  "logoUrl": zod.string().nullish(),
...
export const ListOwnerOrdersQueryParams = zod.object({
  "status": zod.enum(['pending', 'confirmed', 'preparing', 'ready', 'completed', 'cancelled', 'all']).optional(),
  "date": zod.date().optional()
})

export const ListOwnerOrdersResponseItem = zod.object({
  "id": zod.number(),
  "restaurantId": zod.number(),
  "tableId": zod.number().nullish(),
  "tableNumber": zod.string().nullish(),
...
export const GetOwnerOrderResponse = zod.object({
  "id": zod.number(),
  "restaurantId": zod.number(),
  "tableId": zod.number().nullish(),
  "tableNumber": zod.string().nullish(),
 ...
 */
export const AdminListRestaurantsResponseItem = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "slug": zod.string(),
  "description": zod.string().nullish(),
...
export const AdminListRestaurantsResponse = zod.array(AdminListRestaurantsResponseItem)
...
export const ListApprovedResourcesResponse = zod.array(ListApprovedResourcesResponseItem)
...
export const CreateAdminResourceResponse = zod.object({
  "id": zod.number(),
  "title": zod.string(),
  "description": zod.string().nullish(),
  "type": zod.enum(['video', 'pdf', 'link', 'plan', 'faq']),
...
export const UpdateAdminResourceResponse = zod.object({
  "id": zod.number(),
  "title": zod.string(),
  "description": zod.string().nullish(),
  "type": zod.enum(['video', 'pdf', 'link', 'plan', 'faq']),
...
export const DeleteAdminResourceResponse = zod.unknown()
...
export const RejectResourceResponse = zod.object({
  "id": zod.number(),
  "title": zod.string(),
  "description": zod.string().nullish(),
  "type": zod.enum(['video', 'pdf', 'link', 'plan', 'faq']),
...
export const FeatureResourceResponse = zod.object({
  "id": zod.number(),
  "title": zod.string(),
  "description": zod.string().nullish(),
  "type": zod.enum(['video', 'pdf', 'link', 'plan', 'faq']),
 ...
 */
export const GetSensitiveAuthStatusResponse = zod.object({
  "configured": zod.boolean(),
  "unlocked": zod.boolean(),
  "expiresAt": zod.number().nullable().describe('Unix timestamp (ms) when the session unlock expires'),
 ...
 */
export const setupSensitiveAuthBodyPasswordMin = 8;



export const SetupSensitiveAuthBody = zod.object({
  "password": zod.string().min(setupSensitiveAuthBodyPasswordMin)
})

export const SetupSensitiveAuthResponse = zod.object({
  "ok": zod.boolean(),
  "expiresAt": zod.number().describe('Unix timestamp (ms) when the session unlock expires')
})
 ...
 */
export const VerifySensitiveAuthBody = zod.object({
  "password": zod.string()
})

export const VerifySensitiveAuthResponse = zod.object({
  "ok": zod.boolean(),
  "expiresAt": zod.number().describe('Unix timestamp (ms) when the session unlock expires')
})
 ...
 */
export const changeSensitiveAuthBodyNewPasswordMin = 8;



export const ChangeSensitiveAuthBody = zod.object({
  "currentPassword": zod.string(),
  "newPassword": zod.string().min(changeSensitiveAuthBodyNewPasswordMin)
})

export const ChangeSensitiveAuthResponse = zod.object({
  "ok": zod.boolean()
})
 ...
 */
export const LockSensitiveAuthResponse = zod.object({
  "ok": zod.boolean()
})
 ...
 */
export const ExportCustomersCsvQueryParams = zod.object({
...
export const ExportCustomersCsvResponse = zod.unknown()


/**
 * @summary Export customers as Excel (requires sensitive auth)
 */
export const ExportCustomersXlsxQueryParams = zod.object({
  "state": zod.coerce.string().optional(),
  "district": zod.coerce.string().optional(),
  "city": zod.coerce.string().optional(),
  "search": zod.coerce.string().optional()
...
export const ExportCustomersXlsxResponse = zod.unknown()


/**
 * @summary Export restaurants as CSV (requires sensitive auth)
 */
export const ExportRestaurantsCsvQueryParams = zod.object({
  "state": zod.coerce.string().optional(),
  "district": zod.coerce.string().optional(),
  "search": zod.coerce.string().optional()
})

export const ExportRestaurantsCsvResponse = zod.unknown()


/**
 * @summary Export restaurants as Excel (requires sensitive auth)
 */
export const ExportRestaurantsXlsxQueryParams = zod.object({
  "state": zod.coerce.string().optional(),
  "district": zod.coerce.string().optional(),
  "search": zod.coerce.string().optional()
})

export const ExportRestaurantsXlsxResponse = zod.unknown()
