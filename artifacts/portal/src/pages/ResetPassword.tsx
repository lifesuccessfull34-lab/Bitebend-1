...
export default function ResetPassword() {
  ...
  useEffect(() => {
    ...
    apiFetch<{ valid: boolean }>(`/auth/validate-reset-token?token=${encodeURIComponent(token)}`)
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-600 via-orange-500 to-amber-500 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-60 h-60 bg-black/10 rounded-full translate-y-1/3 -translate-x-1/3 pointer-events-none" />
      ...
      {/* Right panel */}
      <div className="flex-1 flex flex-col items-center justify-center bg-orange-50 p-6">
                ...
                <>
                  <div className="flex items-center gap-3 mb-7">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Restaurant owner account</p>
                    </div>
                  </div>
