...
\restrict 6cyitWVrMkNOgD0JtO2AL1QaxmUI3d4SnfoerJZVDDh0qE7cwuyqg6Jsp6BsSLD
...
COPY public.orders (id, restaurant_id, table_id, table_number, customer_name, customer_phone, status, subtotal, tax, total, payment_status, payment_method, notes, created_at, updated_at, payment_screenshot_url, payment_ocr_data, payment_verification_status, razorpay_order_id, razorpay_payment_id, paid_at, verification_method, verified_by, verified_at) FROM stdin;
\.
...
platform_upi_id	bitebend@upi	2026-06-08 12:22:29.418
\.
...
1	Starter	19900	500	Perfect for new restaurants	t	1	months	1	2026-06-08 12:22:29.39932
2	Growth	49900	2000	For growing restaurants	t	2	months	1	2026-06-08 12:22:29.407365
3	Pro	99900	5000	For established restaurants	t	3	months	1	2026-06-08 12:22:29.410806
4	Unlimited	199900	999999	No customer limit — scale freely	t	4	months	1	2026-06-08 12:22:29.414491
\.
...
2	admin@bitebend.in	$2b$10$DmXsSA9ijFc7XLUzipxSx.KuGGJ0dT.yfRYAbWQB11e/syBoPdOAe	Platform Admin	super_admin	\N	\N	2026-06-08 12:21:49.004092
4	updated-owner@testmail.com	$2b$10$EY99n8R.Z7gBtjiB1rvS3Oo5dl/XuMt7hDGSgy.77VvpG6EsYO4V6	Spice Garden Owner	owner	1	\N	2026-06-08 12:22:29.544053
\.
...
SELECT pg_catalog.setval('public.subscription_transactions_id_seq', 1, false);
...
--
-- Name: bill_links bill_links_short_id_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bill_links
    ADD CONSTRAINT bill_links_short_id_unique UNIQUE (short_id);
...
\unrestrict 6cyitWVrMkNOgD0JtO2AL1QaxmUI3d4SnfoerJZVDDh0qE7cwuyqg6Jsp6BsSLD
